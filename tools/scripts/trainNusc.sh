...
#Nuscened
CUDA_VISIBLE_DEVICES=0,1 python3 -m torch.distributed.launch --nproc_per_node=2 ./tools/train.py examples/second/configs/Nuscenes_all_vfev3_spmiddlefhd_rpn1_mghead_syncbn_freatures3.py --work_dir=$NUSC_SECOND_WORK_DIR
#CUDA_VISIBLE_DEVICES=0,1 python3 -m torch.distributed.launch --nproc_per_node=2 ./tools/train.py examples/second/configs/Nuscenes_all_vfev3_spmiddlefhd_rpn1_mghead_syncbn_freatures3.py --work_dir=/home/elodie/det3D_Output/NUSC_SECOND_3_20200428-124425
