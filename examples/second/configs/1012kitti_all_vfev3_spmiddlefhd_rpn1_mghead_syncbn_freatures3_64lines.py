...
### KITTI_SECOND_1_20201012-213854 [train_preprocessor: shuffle_points=False]
...
train_preprocessor = dict(
    mode="train",
    downsample_to_16lines=False, #notice elodie
    noise_per_object=False, #notice elodie
    shuffle_points=True, #notice elodie - voxel size
