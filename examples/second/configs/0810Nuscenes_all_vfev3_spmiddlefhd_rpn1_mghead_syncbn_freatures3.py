...
model = dict(
    type="VoxelNet",
    # pretrained="/home/elodie/det3D_Output/NUSC_SECOND_5_20200710-105923/epoch_10.pth",
...
db_sampler = dict(
    type="GT-AUG",
    enable=False,
    db_info_path="/home/elodie/nuScenes_DATASET/pkl/dbinfos_mix_withoutvelo.pkl",
    sample_groups=[
        dict(car=2),
        dict(pedestrian=2),
        dict(bicycle=4),
...
train_anno = "/home/elodie/DATASET_INFO/infos_train_border.pkl"
