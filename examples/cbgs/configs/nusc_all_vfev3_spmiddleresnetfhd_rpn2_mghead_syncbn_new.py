...
db_sampler = dict(
    type="GT-AUG",
    enable=False,
    db_info_path="/home/dataset/nuScenes_DATASET/pkl/dbinfos_train_10sweeps_withvelo.pkl",
    sample_groups=[
        dict(car=2),
        dict(truck=3),
...
train_anno = "/home/dataset/nuScenes_DATASET/infos_train_10sweeps_withvelo.pkl"
